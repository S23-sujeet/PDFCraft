  ...
  return (
    <div>
      <Seo
        ...
        description="Merge, split, compress, rotate, watermark and convert PDFs for free. No sign-up, no uploads - every tool runs locally in your browser."
        path="/"
      />
      {/* Hero */}
      <section className="bg-hero-mesh relative overflow-hidden border-b border-slate-200 bg-white">
        <div className="mx-auto max-w-6xl px-4 py-20 text-center sm:py-28">
          ...
          <p className="mx-auto mt-5 max-w-2xl text-lg leading-relaxed text-slate-500">
            Merge, split, compress, rotate, watermark and convert PDFs - free, and everything runs right in
      ...
      <section id="tools" className="mx-auto max-w-6xl scroll-mt-20 px-4 pb-6">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-2 text-slate-500">Nine focused tools covering the PDF tasks people need most often.</p>
        </div>
